...
#customer_code { color:#006090; background:white url(../SpitechImages/UserLoginBG.png) right no-repeat; padding-right:30px; padding-left:10px;}
#customer_password { color:#006090; background:white url(../SpitechImages/UserLoginPWD.png) right no-repeat;padding-right:30px; padding-left:10px;}
...
<form name="LoginForm" id="LoginForm" method="post" action="LoginCheck.php">
 <table width="98%" border="0" cellspacing="0" cellpadding="2" id="CommonTable" style="margin-top:0px;">
  ...
  <tr>
    <td width="81" height="22">CUSTOMER CODE ID </td>
    <td width="56">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2">
      <input type="text" name="customer_code" id="customer_code" placeholder="CODE ID" style="width:280px;"  required=""/>
    </td>
    </tr>
  <tr>
    <td>password</td>
  ...
  <tr>
    <td colspan="2"><input type="password" name="customer_password" id="customer_password" placeholder="PASSWORD" style="width:280px;" required/></td>
    </tr>
