...
#user_password { color:#006090; background:white url(../SpitechImages/UserLoginPWD.png) right no-repeat;padding-right:30px; padding-left:10px;}
...
<form name="LoginForm" id="LoginForm" method="post" action="LoginCheck.php" style="margin:0px;">
  ...
  <tr>
    <td height="22" colspan="2" style="text-align:center">User Login Here :<hr/></td>
  </tr>
  <tr>
    <td height="22" colspan="2"><?php ErrorMessage();LoginError();?></td>
    </tr>
    <tr>
    <td width="81" height="22">User ID</td>
    <td width="56">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2">
    	...
    	?>
      <input type="text" value="<?php echo $user_id;?>" name="user_id" id="user_id" placeholder="USER ID" style="width:300px;"  required=""/>
  ...
  <tr>
    <td colspan="2">
    	...
    	?>
    	<input type="password" value="<?php echo $user_password;?>" name="user_password" id="user_password" placeholder="PASSWORD" style="width:300px;" required/></td>
    </tr>
  <?php 
...
<table width="100" border="0" cellspacing="0" cellpadding="2" style="margin-top:3px;">
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="59" style="text-align:left"><input type="text" name="user_captcha" id="user_captcha" size="12" maxlength="16" placeholder="CODE" style="width:140px;" required=''/></td>
  </tr>
...
<?php 
BirthDaySMS(); AnniversarySMS(); TokenExpiryBeforeSMS(); TokenExpiryTodaySMS(); TokenExpiryAfterSMS() 
