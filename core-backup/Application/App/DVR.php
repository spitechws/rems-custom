            ...
            <form name="FindForm" id="FindForm" method="get" >
                ...
                <table width="98%" border="1" cellspacing="0" cellpadding="0" id="SearchTable" class="SearchTable" style="margin-top:5px;">
                    <tr>
                        ...
                        <td width="*" style="line-height:12px"> Customer Name</td>
                    ...
                    <tr>           
                        ...
                        <td>
                            <input type="text" name="customer_name" id="customer_name" placeholder="NAME" value="<?php echo $_GET['customer_name']; ?>" maxlength="50" style="width:100px"/>
                        </td>
            ...
            <table width="98%" border="0" cellspacing="1" cellpadding="0" id="Data-Table">
                ...
                if (isset($_GET['Search'])) {
                    ...
                    if ($_GET['customer_name'] != "") {
                        $DVR_QUERY .= " and customer_name ='" . $_GET['customer_name'] . "'";
                    }
                    if ($_GET['mobile_no'] != "") {
                ...
                while ($DVR_ROWS = @mysqli_fetch_assoc($DVR_QUERY)) {
                    ...
                    <tr id="<?php echo $id ?>">
                        ...
                        <td width="290"><?php echo $DVR_ROWS['remarks']; ?></td>
                        <td width="56" style="text-align:center"><?php echo $DVR_ROWS['status']; ?></td>
                        <td>
