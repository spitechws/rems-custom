...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="Content">
  <tr>
    ...
    <th width="7%" colspan="2" rowspan="2" class="Action">ACTION</th>
  </tr>
      <tr>
        <th width="16%">NAME</th>
...
?>
  <tr>
    ...
    <td style="margin:1PX; padding:1PX; text-align:center;" title="View Profile Of <?php echo advisor_title?> : <?php echo $ADVISOR_ROWS['advisor_name']; ?>">
    ...
    <td class="Action"><div align="center" style="width:80px;"> 
       ...
       <a id="Profile" href="<?php echo "Advisor_Profile.php?".md5('advisor_id')."=".$ADVISOR_ROWS['advisor_id'];?>" title="View Profile Of <?php echo advisor_title?> : <?php echo $ADVISOR_ROWS['advisor_name']; ?>"></a> 
       
      <a id="Edit" href="<?php echo "Advisor_New.php?".md5('edit_id')."=".$ADVISOR_ROWS['advisor_id'];?>" title="Edit Profile Of <?php echo advisor_title?> : <?php echo $ADVISOR_ROWS['advisor_name']; ?>">&nbsp;</a> 
      

      </td>
    <td class="Action">
     <a href="Advisor_New_Next.php?<?php echo  md5("advisor_id")."=".$ADVISOR_ROWS['advisor_id']; ?>&Send=No" title="Print Welcome Again">
        <img src="../SpitechImages/Print.png" style="width:15px; height:15px" />
     </a>
    </td>
  </tr>
  <?php } ?>
...
if(isset($_GET[md5("advisor_delete_id")]) && $_GET[md5("advisor_delete_id")]!="1")
{
    ...
    //==================( ENQUIRY  )=================================	
	@mysqli_query($_SESSION['CONN'],"Delete From tbl_advisor_dvr where advisor_id='".$_GET[md5("advisor_delete_id")]."'");	
		
	//==================( EXTRA CHARGE )=============================
	@mysqli_query($_SESSION['CONN'],"Delete From tbl_property_booking_extra_charge where
	              booking_id in(select booking_id from tbl_property_booking where booking_advisor_id='".$_GET[md5("advisor_delete_id")]."'");		
	...
	$DBOBJ->UserAction(advisor_title." DELETED","ID=".$_GET[md5("advisor_delete_id")].", NAME : ".$DELETE_ROW['advisor_name']);	
	header("location:Advisor.php?Message=".advisor_title." : ".$DELETE_ROW['advisor_name']." Deleted.");	
}
