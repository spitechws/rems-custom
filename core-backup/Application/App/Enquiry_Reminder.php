...
<h1><img src="../SpitechImages/EnquiryReminder.png" />Enquiry : <span>Reminder</span></h1>
            ...
            <form name="FindForm" id="FindForm" method="get" >
                ...
                <table width="98%" border="1" cellspacing="0" cellpadding="0" id="SearchTable" class="SearchTable" style="margin-top:5px;">
                    <tr> 
                        ...
                        <td colspan="2">FROM --- To ---- DATE</td>                        
                        <TD width="4%">STATUS</TD>
                        <td colspan="2">Action</td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" name="mobile_no" id="mobile_no" placeholder="Mobile Number" value="<?php echo $_GET['mobile_no']; ?>"/>
                        </td>
                        ...
                        <td width="36%"><input type="button" name="All" value="Show All" class="Button" onclick="window.location = 'Enquiry_Reminder.php';" /></td>
                    </tr>
                </table>
            </form>
...
//----------------------------------------------------------		
                ...
                if (isset($_GET['Search'])) {
                    ...
                    if ($_GET['status'] != "All") {
                        $ENQ_QUERY .= " and status ='" . $_GET['status'] . "'";
                    }
                }
                ...
                while ($ENQ_ROWS = @mysqli_fetch_assoc($ENQ_QUERY)) {
                    ...
                    <tr id="<?php echo $id ?>">
                        ...
                        <td><div align="center" style="width:90px;"> <a id="Report" <?php Modal("Enquiry_View.php?" . md5("enquiry_id") . "=" . $ENQ_ROWS['enquiry_id'], "950px", "500px", "500px", "100px"); ?> title="View  Enquiry Details">&nbsp;&nbsp;</a> <a id="Edit" <?php Modal("Enquiry_New.php?" . md5("edit_id") . "=" . $ENQ_ROWS['enquiry_id'], "1000px", "700px", "350px", "100px"); ?> title="Edit  Enquiry Details">&nbsp;</a> <a id="Delete" href="Enquiry.php?<?php echo md5("enquiry_delete_id") . "=" . $ENQ_ROWS['enquiry_id']; ?>" <?php Confirm("Are You Sure ? Delete This Expense Entry ? "); ?>  title="Delete Enquiry ">&nbsp;</a></div></td>
                    </tr>
                <?php } ?>
            </table>    <div align="right" class="paginate"><?php pagination($PAGINATION_QUERY, $limit, $page, url('Enquiry_Reminder.php')); ?></div>
...
if ($_GET[md5("enquiry_delete_id")] > 0) {
    ...
    $DBOBJ->UserAction("ENQUIRY DELETED", " ID : " . $_GET[md5("enquiry_delete_id")] . ", CUSTOMER : " . $DELETE_ROW['customer_name']);
    header("location:Enquiry_Reminder.php?Message=Selected Enquiry Have Been Deleted Successfully.");
}
