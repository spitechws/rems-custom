...
<form name="FindCom" id="FindCom" method="get" style="margin-top:-5px;" >       
...
?>
          <tr <?php if($COMMISSION=="0" ||$COMMISSION==""  ||$COMMISSION==NULL) { echo "id=Hide".$Hide++; } ?>>
            ...
            <td><div align="center"><?php echo date('d-M-Y',strtotime($COMMISSION_ROWS['commission_date']));?></div></td>
            <td><div align="center"><?php echo date('d-M-Y',strtotime($COMMISSION_ROWS['commission_voucher_date']));?></div></td>
            ...
            <td width="26"><?php echo $ADVISOR_CODE?></td>
