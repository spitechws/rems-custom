        ...
        <td >
            ...
            <form name="FindForm" id="FindForm" method="get" >
                ...
                <table width="98%" border="1" cellspacing="0" cellpadding="0" id="SearchTable" class="SearchTable" style="margin-top:5px;">
                    <tr>                        
                        <td width="*" style="line-height:12px">Name</td>
                    ...
                    <tr>                       
                        <td>
                            <input type="text" name="customer_name" id="customer_name" placeholder="NAME" value="<?php echo $_GET['customer_name']; ?>" />
                        </td>   
                        <td>
...
//----------------------------------------------------------		
                ...
                if (isset($_GET['Search'])) {
                    if ($_GET['customer_name'] != "") {
                        $ENQ_QUERY .= " and customer_name ='" . $_GET['customer_name'] . "'";
                    }
                    if ($_GET['status'] != "All") {
