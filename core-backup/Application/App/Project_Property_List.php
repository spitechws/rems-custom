...
<center>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="Content">
        ...
        <center>
            <?php ErrorMessage(); ?>
            <form name="FindForm" id="FindForm" method="get" style="display:<?php
            ...
            <table width="98%" border="0" cellspacing="1" cellpadding="0" id="Data-Table">
                ...
                if (isset($_GET['Search'])) {
                    if ($_GET[md5('property_project_id')] != "All") {
                        $PROPERTY_QUERY .= " and property_project_id='" . $_GET[md5('property_project_id')] . "' ";
                    }
                    if ($_GET[md5('property_type_id')] != "All") {
                        $PROPERTY_QUERY .= " and property_type_id ='" . $_GET[md5('property_type_id')] . "' ";
                    }
                    if ($_GET[md5('property_id')] != "All") {
                        $PROPERTY_QUERY .= " and property_id ='" . $_GET[md5('property_id')] . "' ";
                    }
                    if ($_GET[md5('property_status')] != "All") {
                        $PROPERTY_QUERY .= " and property_status ='" . $_GET[md5('property_status')] . "' ";
                    }
                }
                ...
                while ($PROPERTY_ROWS = @mysqli_fetch_assoc($PROPERTY_QUERY)) {
                    ...
                    <tr>
                        ...
                        <td style="background:<?php echo $BG_COLOR ?>; color:<?php echo $COLOR ?>;"><div align="center">
                                <span><?php echo $PROPERTY_ROWS['property_status']; ?></span>
                                <?php if ($aModules['property_regular_update'] && $PROPERTY_ROWS['property_status']=="Booked") { ?>
                                &nbsp;|&nbsp;<span><a style="color:white;" href="Project_Property_Updates.php?<?php echo md5('property_id') . "=" . $PROPERTY_ROWS['property_id']; ?>">Photo Update</a></span>
                                <?php } ?>
                            </div>
                        </td>

                        <td width="6%" style="text-align:center;background:<?php echo $BG_COLOR ?>; color:<?php echo $COLOR ?>;" class="Action">

                            <?php
                            if ($STATUS == "Available") {
                                $EDIT_DISPLAY = 'inline';
                                ?>
                                <a href="Project_Property_Booking.php?<?php echo md5('booking_project_id') . "=" . $PROPERTY_ROWS['property_project_id'] . "&" . md5('booking_property_id') . "=" . $PROPERTY_ROWS['property_id']; ?>">
                                    <img src="../SpitechImages/PropertyBook.png" width="30" height="21"  title="Book Property : <?php echo $PROPERTY_ROWS['property_no']; ?>, Of Project : <?php echo $PROJECT_NAME; ?>"/>
                                </a>
                        ...
                        <td width="8%" class="Action"><div align="center" style="width:90px;">     
                                <a id="Edit" <?php Modal("Project_Property_Edit.php?" . md5("edit_id") . "=" . $PROPERTY_ROWS['property_id'], "650px", "400px", "300px", "100px"); ?> title="Edit Property : <?php echo $PROPERTY_ROWS['property_no']; ?>" style="display:<?php echo $EDIT_DISPLAY; ?>">&nbsp;</a> 



                                <a id="Delete" href="Project_Property_List.php?<?php echo md5("property_delete_id") . "=" . $PROPERTY_ROWS['property_id']; ?>" <?php Confirm("Are You Sure ? Delete Property : " . $PROPERTY_ROWS['property_no'] . " ? "); ?>  title="Delete Profile of Property : <?php echo $PROPERTY_ROWS['property_no']; ?>">&nbsp;</a></div>
...
<?php
if (isset($_GET[md5("property_delete_id")])) {
    NoAdmin();
    $DELETE_ROW = $DBOBJ->GetRow("tbl_property", "property_id", $_GET[md5("property_delete_id")]);
    @mysqli_query($_SESSION['CONN'], "Delete From tbl_property where property_id='" . $_GET[md5("property_delete_id")] . "'");
    ...
    header("location:Project_Property_List.php?Message=Property+:+" . $DELETE_ROW['property_no'] . "+Deleted.&" . md5("property_project_id") . "=" . $DELETE_ROW['property_project_id'] . "&" . md5("property_id") . "=All&" . md5("property_type_id") . "=All&" . md5("property_status") . "=All&Search=+");
}
