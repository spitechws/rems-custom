...
include_once("../php/SpitechJS.php");
	...
	$DBOBJ->ConnectDatabase();
	 NoAdvisor();
	$ENQUIRY_ROW=$DBOBJ->GetRow("tbl_advisor_dvr","dvr_id",$_GET[md5("dvr_id")]); 
	CheckAdvisor("tbl_advisor_dvr","dvr_id",$_GET[md5("dvr_id")]);
      ...
      <tr>
        ...
        <table width="98%" border="0" cellspacing="2" cellpadding="0" style="margin-top:0PX;">
          ...
          <tr>
            ...
            <td class="Value"><div align="left"><?php echo date('d-M-Y',strtotime($ENQUIRY_ROW['dvr_date']))?></div></td>
          </tr>
          <tr>
