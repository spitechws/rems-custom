...
<table width="98%" border="0" cellspacing="1" id="SearchTable" style="margin-top:0px;">
  <tr>
	...
	?></td>
     <td width="5%" id="Field">PROPERTY&nbsp;:</td>
      <td width="11%" id="Value"><?php 
    ...
    <td width="10%" id="Value"><div style="width:60px;"><?php echo date('d-M-Y',strtotime($s_date))?></div></td>
    <td width="4%">to&nbsp;:</td>
    <td width="7%" id="Value"><?php echo date('d-M-Y',strtotime($e_date))?></td>
    ...
    <table width="100%"  id="Data-Table"  cellspacing="1">
      ...
      <?php
		...
		{	
			...
			$COMMISSION_QUERY.=" and commission_date between '$s_date' and '$e_date' ";					
		}
...
?>
      <tr <?php if($COMMISSION=="0" ||$COMMISSION==""  ||$COMMISSION==NULL) { echo "id=Hide".$Hide++; } ?>>
        ...
        <td width="26"><div style="width:60px;" align="center"><?php echo $ADVISOR_C?></div></td>
        ...
        <td><div style="width:70px;" align="center"><?php echo $CUSTOMER_CODE?></div></td>
        <td><div align="left" style="width:150PX;"><?php echo $CUSTOMER_NAME?></div></td>
        <td width="26"><div style="width:60px;" align="center"><?php echo $ADVISOR_CODE?></div></td>
