  ...
  <tr>
    ...
    <table  width="100%"  cellspacing="1" id="Data-Table" style="margin:0PX; width:100%; padding:0px;">
      <tr  >
        ...
        <th width="3%" rowspan="2" >PROP&nbsp;NO</th>
        <th colspan="2" >CUSTOMER&nbsp;details</th>
        <th colspan="2" >BOOKED&nbsp;BY&nbsp;<?php echo advisor_title?></th>
        <th width="3%" rowspan="2" >MRP</th>
        <th width="5%" rowspan="2" >DISCOUNT</th>
        <th width="6%" rowspan="2" >DISC MRP</th>
        <th width="4%" rowspan="2" >RECEIVD</th>
        <th width="12%" rowspan="2" >BALANCE</th>
        <th width="12%" rowspan="2" >STATUS</th>
        <th width="4%" rowspan="2" class="Action">ACTION</th>
      </tr>
      <tr  >
      ...
      <?php      	$page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);	
		...
		//----------------------------------------------------------		
		$BOOKING_QUERY="select * from tbl_property_booking where booking_advisor_id in (".$_SESSION['advisor_team'].") and approved='1' ";
...
?>
      <tr >
        ...
        <td style="background:<?php echo $BG?>;color:<?php echo $color?>"><div align="center" style="width:80px;"><?php echo $EXP_DATE;?> </div></td>
        ...
        <div align="center"> 
       		<a id="Report" title="View Account" href="Project_Property_Booking_Accounts.php?<?php echo md5('booking_id')."=".$BOOKING_ROWS['booking_id'];?>">&nbsp;&nbsp;View</a></div>
        </td>
